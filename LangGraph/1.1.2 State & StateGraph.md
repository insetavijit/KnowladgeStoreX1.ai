...
|**[[1.1.2.10 StateGraph vs Other Graph Types]]**|Choosing graph type|StateGraph, MessageGraph, specialized graphs|StateGraph is the foundation for stateful workflows in LangGraph.|
