...
| ---------------------- | ---------------------------------------- | ------------------------------------------------ |
| **NLP Foundations**    | Language understanding & text processing | [[NLP]] (tokenization, embeddings, NER, parsing) |
| **LLM Orchestration**  | Prompting, chaining, tool calling        | [[LangChain]]                                    |
