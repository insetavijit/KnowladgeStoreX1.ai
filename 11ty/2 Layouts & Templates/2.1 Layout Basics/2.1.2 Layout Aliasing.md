...
If you have 500 blog posts and you decide to reorganize your `_includes` folder or rename `main-post-v2.njk` to `article.njk`, you have to find and replace that string in **500 files**. This is "shotgun surgery"—a single conceptual change requiring edits in many places.
