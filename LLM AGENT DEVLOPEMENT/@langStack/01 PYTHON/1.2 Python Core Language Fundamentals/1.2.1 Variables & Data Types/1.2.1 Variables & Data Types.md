...
| ------------------------------------------ | -------------------------------------------------------- | -------------------------------------------------------------------------- | -------------------------------------------------------- |
| **[[1.2.1.1 Variable Declaration]]**        | Understand how variables are created and bound in Python | name binding, assignment operator `=`, reassignment                        | Variables are labels bound to objects, not containers.   |
